...
import { BackendExport } from "./vmontage/backend-export";
import { SaveEdlButton } from "./vmontage/save-edl-button";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
    ...
    <div className="h-13 border-b shrink-0">
      <div className="h-full grid grid-cols-3 items-center px-4">
        ...
        <div className="flex items-center justify-end gap-2">
          ...
          {/* vmontage: 保存 GUI 微调回 edl.json */}
          <SaveEdlButton />

          {/* vmontage: 导出改调后端 render(浏览器导出弃用,保留组件未挂载) */}
          <BackendExport />
        </div>
      </div>
    </div>
